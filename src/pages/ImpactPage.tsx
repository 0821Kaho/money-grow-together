      ...
      <header className="container mx-auto py-6 px-4">
        <div className="flex items-center">
          <Link to="/" className="flex items-center gap-2">
            <h1 className="text-2xl font-logo text-[#333333]"><span className="font-extrabold">Pigipe</span></h1>
          </Link>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            ...
            <h1 className="text-3xl md:text-4xl font-heading font-bold mb-3 text-[#333333]">
              <span className="font-extrabold">Pigipe</span> がもたらす経済・社会的効果
            </h1>
          ...
          <section className="mb-16">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm mb-8">
              <p className="mb-4">
                <span className="font-extrabold">Pigipe</span> は、<span className="font-bold">完全無料で学べる金融教育プログラム</span> を通じ
              </p>
