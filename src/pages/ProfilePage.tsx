...
const ProfilePage = () => {
  // Progress values
  const experienceProgress = 25; // Example: 125/500 = 25%
    ...
    <GameLayout>
      ...
      <div className="rounded-2xl bg-white p-6 shadow-sm">
        <div className="flex flex-col items-center">
          <div className="mb-4 h-24 w-24 rounded-full bg-game-secondary text-white flex items-center justify-center text-3xl font-bold">
            ユ
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="flex flex-col items-center opacity-40">
              <div className="achievement-badge mb-2 bg-[#E0E0E0]">
                <div className="achievement-badge-inner">
                  <span className="text-2xl">❓</span>
                </div>
              </div>
